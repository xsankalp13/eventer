            ...
            <div className='flex w-full flex-col gap-8 p-5 md:p-10'>
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex flex-col gap-3 sm:flex-row sm:items-center'>
                        ...
                        <p className='p-medium-18 ml-12 mt-2 sm:mt-0'>
                            by{' '}
                ...
                <div className='flex flex-col gap-5'>
                    <div className='flex gap-2 md:gap-3'>
                        <Image 
                            ...
                            height={32}
                        />
                        <div className='p-medium-16 lg:p-regular-16 flex flex-wrap items-center'>
                            <p>{formatDateTime(event.startDate).dateOnly} - {' '}
                                {formatDateTime(event.startDate).timeOnly} / {' '}
                            </p>
                            <p className='ml-1'>{formatDateTime(event.endDate).dateOnly} - {' '}
